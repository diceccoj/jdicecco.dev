        ...
        <div className="flex justify-center items-center mt-10">
          <div className="responsive-grid lg:space-x-10 space-y-10 lg:w-2/3 place-items-center">
            ...
            >
              ...
              have more time.`,
                `Right now, it has 3 different widgets, which tell
            ...
            >
              ...
              before I primarily stuck to CSS.`,
                `Whether it be adding the light
              ...
              Javascript, which I really liked and value the things I learned.`,
                `I made a website before, but I followed a template and made
              mistakes at the sacrifice of code cleanliness. This project feels
              a lot more personal as I wanted to make something to do in my
              everyday life.`,
              ]}
            </ColorBox>
            <ColorBox
            ...
            >
              ...
              the widget color to whatever the user wants.`,
                `Also, after I learned
