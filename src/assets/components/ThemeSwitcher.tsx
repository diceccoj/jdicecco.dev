...
//Theme swicther imported from https://tw-elements.com/docs/react/getting-started/dark-mode/#:~:text=Enabling%20dark%20mode,class%20on%20your%20html%20element.
...
const ThemeSwitcher: React.FC = (): JSX.Element => {
  ...
  const dropdownMenuClasses = clsx(
    " outline  min-w-max absolute bg-white text-base z-[1000] overflow-hidden float-left list-none text-left rounded-lg shadow-lg m-0 bg-clip-padding border-none dark:bg-neutral-800",
    ...
    <>
      ...
      >
        <div className="relative">
          <button
            ref={switcherButton}
            className="w-[30px] h-[30px] bg-neutral-300 dark:bg-neutral-600 text-neutral-800 dark:text-white uppercase rounded-full hover:shadow-lg hover:bg-neutral-200 dark:hover:bg-neutral-700 focus:bg-neutral-300 dark:focus:bg-neutral-700 focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg transition duration-150 ease-in-out flex items-center justify-center whitespace-nowrap motion-reduce:transition-none"
            type="button"
            id="themeSwitcher"
            aria-expanded="false"
